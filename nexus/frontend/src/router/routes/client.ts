...
const clientRoutes: RouteRecordRaw[] = [
    ...
    {
        path: '/earn/daily-claim',
        name: 'Daily Claim',
        component: () => import('@/views/client/earn/DailyClaim.vue'),
        meta: {
            requiresAuth: true,
        },
    },
    ...
    {
        path: '/store/resource-packages',
        name: 'Resource Packages',
        component: () => import('@/views/client/store/ResourcePackages.vue'),
        meta: {
            requiresAuth: true,
        },
    },
    ...
    },
    {
        path: '/queue',
        name: 'Server Queue',
        component: () => import('@/views/client/Queue.vue'),
        meta: {
            requiresAuth: true,
        },
    },
