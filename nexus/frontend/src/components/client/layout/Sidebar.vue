...
// Define Daily Claim menu item
const dailyClaimMenuItem = {
    name: t('components.sidebar.daily_claim'),
    icon: Calendar,
    href: '/earn/daily-claim',
    active: isActiveRoute(['/earn/daily-claim']),
};
...
const resourcePackagesMenuItem = {
    name: 'Resource Packages',
    icon: Coins,
    href: '/store/resource-packages',
    active: isActiveRoute(['/store/resource-packages']),
};
...
const storeMenuItem = {
    ...
    href: '/store',
    active: isActiveRoute(['/store', '/store/resource-packages']),
    subitems: [
        {
            name: t('components.sidebar.store'),
            icon: ShoppingCartIcon,
...
const getEarnItems = computed(() => {
    ...
    // Daily claim is always available
    items.push(dailyClaimMenuItem);
...
const menuSections = ref<MenuSection[]>([
    {
        ...
        items: [
            dashboardMenuItem,
            ...(isServersEnabled.value ? [serversMenuItem, queueMenuItem] : []),
