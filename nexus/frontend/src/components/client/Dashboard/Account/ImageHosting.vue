...
const embedSettings = ref({
    ...
    title: Session.getInfo('image_hosting_embed_title') || 'NEXUS Image',
    description:
        Session.getInfo('image_hosting_embed_description') ||
        'NEXUS ImageHosting is a nice plugin bridge for creating a image hosting inside NEXUS :D',
    ...
    authorName: Session.getInfo('image_hosting_embed_author_name') || 'NEXUS',
});
